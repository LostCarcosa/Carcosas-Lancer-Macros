...
if (!isNaN(damage)) {
  ...
  selectedTokens.forEach(token => {
    ...
    if (results.buttons == 1) {
      ...
      token.actor.update({ "system.hp.value": hp - tempdamage, "system.burn": burn + burndamage }); //hp damage taken might be reduced by overshield, but burn gained is not.
      ...
      if (heat + tempdamage > token.actor.system.heat.max) {
