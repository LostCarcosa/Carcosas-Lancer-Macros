...
V1.2: (Tentative) V11 Compatiability (which involves adapting to new compendium structure). 
	(Worked for test cases. Have not tested extensively.)
...
- Gets real mad if you have a class whose name contains the name of another class (i.e 'Scout Craft' from Enhanced Combat contains 'Scout'; macro does not like this). Will try to get this one fixed. 
...
async function populateOptionals(actor, ctItem, optionals){
	...
	console.log(featureLids)
	console.log(featureNames)
	// this is a list of lids
	
	/*
	let optionalFeatureNames = []
	for(let lid of optionalFeatures){
		optionalFeatureNames.push(getOptFeatNameFromLid(lid))
	}
	*/
